...
object DataDummy {
    ...
    fun generateDummyMovies(): List<EntityMovie> {
        val movies = ArrayList<EntityMovie>()
        ...
        movies.add(
            EntityMovie(
                ...
                "/1jkNM1NHyHsxiBBuOlOeqgmidM0.jpg",
                false,
                "804435"
            )
        )
        ...
        movies.add(
            EntityMovie(
                ...
                "/xD9mc8JCVXA8T8u4Od7qOUBuGH4.jpg",
                false,
                "573680"
    ...
    fun generateDummyDetailMovie(id: String): EntityMovie {
        val movies = ArrayList<EntityMovie>()
        ...
        var movieSelected = EntityMovie("", "", "", "", "", false, "")
        for (movie in movies) {
            if (movie.id == id) {
                movieSelected = movie
            }
    ...
    fun generateDummySeries(): List<EntityTvSerial> {
        val series = ArrayList<EntityTvSerial>()
        series.add(
            EntityTvSerial(
                "Lucifer",
                "2016-01-25",
    ...
    fun generateDummyDetailTVSerial(id: String): EntityTvSerial {
        val series = ArrayList<EntityTvSerial>()
        ...
        var tvSerialSelected =
            EntityTvSerial("", "", "", "", "", false, "")
        for (tvSerial in series) {
            if (tvSerial.id == id) {
                tvSerialSelected = tvSerial
            }
        }

        return tvSerialSelected
    }
